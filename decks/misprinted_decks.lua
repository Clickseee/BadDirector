					...
					func = function()
						...
						for i, joker in ipairs(G.jokers.cards) do
							if (joker.edition and joker.edition.key ~= "e_negative") or joker.edition == nil then
								BadDirector.MisprintedDecks.b_black.config.count = BadDirector.MisprintedDecks.b_black.config.count + 1
							end
						end
						if BadDirector.MisprintedDecks.b_black.config.count > 0 then
							G.GAME.round_resets.hands = G.GAME.round_resets.hands - BadDirector.MisprintedDecks.b_black.config.count
